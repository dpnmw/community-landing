...
module CommunityLanding
  module Icons
    ...
    QUOTE_SVG = '<svg class="cl-about__quote-mark" viewBox="0 0 24 24" fill="currentColor" width="32" height="32"><path d="M18 7h-3l-2 4v6h6v-6h-3zm-8 0H7L5 11v6h6v-6H8z"/></svg>'
